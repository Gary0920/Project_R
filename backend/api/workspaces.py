...
from app.features.workspaces.permissions import (
    ...
    ensure_mutable_membership_workspace as _ensure_mutable_membership_workspace,
    ensure_workspace_admin as _ensure_workspace_admin,
    has_workspace_group_access as _has_workspace_group_access,
    is_workspace_admin as _is_workspace_admin,
    local_workspace_admin_count as _local_workspace_admin_count,
    normalize_group_name as _normalize_group_name,
    resolve_member_target_user as _resolve_member_target_user,
    serialize_workspace_member as _serialize_workspace_member,
    validate_workspace_member_role as _validate_workspace_member_role,
    workspace_access_groups as _workspace_access_groups,
    workspace_membership as _workspace_membership,
)
