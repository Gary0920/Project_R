...
def _ensure_sqlite_columns() -> None:
    ...
    migrations = [
        ...
        ("workspace_files", "source_hash", "ALTER TABLE workspace_files ADD COLUMN source_hash VARCHAR(64) NOT NULL DEFAULT ''"),
        ("workspace_files", "source_size", "ALTER TABLE workspace_files ADD COLUMN source_size INTEGER NOT NULL DEFAULT 0"),
        ("workspace_files", "source_mtime", "ALTER TABLE workspace_files ADD COLUMN source_mtime VARCHAR(64) NOT NULL DEFAULT ''"),
