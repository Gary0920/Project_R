...
相关进度：GBrain 功能盘点见 `docs/product/gbrain-feature-inventory.md`；Project_R 对 GBrain 的适配完成度、未闭环项和下一步顺序见 `docs/milestones/gbrain-adaptation-progress.md`。
